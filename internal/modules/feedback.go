...
func FeedbackHandler(ds *discordgo.Session, msg *discordgo.Message, ctx *router.Context) {
	if len(ctx.Fields) == 1 {
		return
	}
	...
	ds.ChannelMessageSend(issuesChannel.ID, "**New feedback from "+msg.Author.Username+"**: "+i)
}
